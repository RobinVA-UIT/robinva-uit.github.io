...
This is an analysis of `CreateProcessA`, one of the most used Win32 APIs. Most of the information below is referenced from the [Microsoft Docs](https://learn.microsoft.com/en-us/windows/win32/api/processthreadsapi/nf-processthreadsapi-createprocessa) of this API.

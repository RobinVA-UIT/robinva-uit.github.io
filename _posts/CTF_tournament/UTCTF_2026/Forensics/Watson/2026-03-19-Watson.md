---
title: UTCTF2026 - Watson  # Tên bài viết sẽ hiện to đùng
date: 2026-03-19 22:00:00 +0700      # Thời gian đăng (Quan trọng: +0700 là giờ VN)
categories: [CTF, Tournaments, UTCTF2026]         # Danh mục lớn, danh mục con
tags: [disk forensics, amcache, prefetch, eric zimmerman's tools]     # Tag để tìm kiếm (viết thường)
author: "RobinVA"
---
...
![briefing](/assets/img/UTCTF2026/Watson/briefing.png)
...
![how-to-solve](/assets/img/UTCTF2026/Watson/how-to-solve.png)
...
![c](/assets/img/UTCTF2026/Watson/c.png)

Inside it, there were two more folders:

![rec_bin](/assets/img/UTCTF2026/Watson/rec_bin.png)

The first one, `S-1-5-18`, just contained `desktop.ini`, so there was nothing interesting there:

![S-1-5-18](/assets/img/UTCTF2026/Watson/S-1-5-18.png)

The second one, `S-1-5-21-47857934-2514792372-2285641962-500`, on the other hand, had a bunch of fun stuff:

![S-1-5-21-47857934-2514792372-2285641962-500](/assets/img/UTCTF2026/Watson/S-1-5-21-47857934-2514792372-2285641962-500.png)
...
![project](/assets/img/UTCTF2026/Watson/project.png)
...
![firsthalf](/assets/img/UTCTF2026/Watson/firsthalf.png)

![firstflag](/assets/img/UTCTF2026/Watson/firstflag.png)
...
![prefetch](/assets/img/UTCTF2026/Watson/prefetch.png)
...
![calc](/assets/img/UTCTF2026/Watson/calc.png)
...
![amcache](/assets/img/UTCTF2026/Watson/amcache.png)
...
![csv](/assets/img/UTCTF2026/Watson/csv.png)
...
![checkpointb](/assets/img/UTCTF2026/Watson/checkpointb.png)

![secondflag](/assets/img/UTCTF2026/Watson/secondflag.png)
